...
import com.academyinfo.image.Class.service.ClassImageService;
...
public class IndexController {
	...
	private ClassImageService classImageService;
	...
	public String index(Model model) {
		...
		List<ClassImageResponseDto> listImage = classImageService.getImage();
		...
		model.addAttribute("listImg", listImage);
