...
public class ReviewServiceImpl implements ReviewService {
	...
	public int reviewSave(String id, int cindex, ReviewRequestDto dto) {
		...
		calculateScore(dto.getScore(), classes, 1);
	...
	@Transactional
	public void calculateScore(double score, ClassEntity classes, int sign) { // score : 수강후기 별점
		...
		int rvcount = rvEntity.size(); // 수강후기 갯수
		...
		if (rvcount == 1) { // 삭제 시 남은 review가 0이 될 경우
			cScore = 0;
			updatedScore = 0;
		} else {
